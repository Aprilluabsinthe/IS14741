...
# modify here
char_deal = 16
pn_value = "22323030302d30312d3037222c2022"
filename = "try_last3_16.txt"
...
for i in range(hex_len):
    ...
    last_nchar = cookie_c1_origin[32-(char_deal*2):]
    cookie_c1 = cookie_c1_origin[:32-(char_deal*2)] + sxor(last_nchar, guess_xor_pad).zfill(char_deal*2)
    print  "\noriginal C_[1][m]: ", last_nchar, "  guess: ", guess, "  Xored: ", guess_xor_pad
    print "Xored Cookie C_[1][%d]: ", sxor(cookie_c1_origin[32-(char_deal*2):], guess_xor_pad).zfill(char_deal*2)
    cookie = cookie_IV + cookie_c0 + cookie_c1 + cookie_c2
